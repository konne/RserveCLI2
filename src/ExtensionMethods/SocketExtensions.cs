...
namespace RserveCLI2
{
    ...
    {
#if !NETSTANDARD1_3
        public static Task<int> SendAsync(this Socket socket1, byte[] buffer)
        {
            Socket socket = socket1;
            if (socket == null) throw new ArgumentNullException(nameof(socket1));
        ...
        public static Task<int> ReceiveAsync(this Socket socket1,
        ...
        public static Task ConnectAsync(this Socket socket1, System.Net.EndPoint endPoint)
        {
            Socket socket = socket1;
            if (socket == null) throw new ArgumentNullException(nameof(socket1));
